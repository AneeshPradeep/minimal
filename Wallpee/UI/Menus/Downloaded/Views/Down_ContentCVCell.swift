...
protocol Down_ContentCVCellDelegate: AnyObject {
    func favouriteDidTap(cell: Down_ContentCVCell)
}

class Down_ContentCVCell: UICollectionViewCell {
    ...
    //MARK: - Properties
    static let id = "Down_ContentCVCell"
    
    weak var delegate: Down_ContentCVCellDelegate?
...
extension Down_ContentCVCell {
    ...
    private func configreCell() {
        ...
        NSLayoutConstraint.activate([
            ...
            favView.trailingAnchor.constraint(equalTo: coverImageView.trailingAnchor, constant: -10.0),
            favView.bottomAnchor.constraint(equalTo: coverImageView.bottomAnchor, constant: -10.0),
...
extension Down_ContentCVCell: ButtonAnimationDelegate {
