...
public extension SFWConfiguration {
    ...
    struct WheelPreferences {
        ...
        public var layerInsets = UIEdgeInsets(top: -50, left: -50, bottom: -50, right: -50)
...
public extension SFWConfiguration {
    ...
    struct SpinButtonPreferences {
        ...
        public var cornerColor: UIColor = .clear
        ...
        public var font = UIFont(name: FontName.montSemiBold, size: 16.0)
