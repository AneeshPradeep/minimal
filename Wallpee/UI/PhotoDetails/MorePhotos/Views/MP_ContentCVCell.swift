...
class MP_ContentCVCell: UICollectionViewCell {
    ...
    //MARK: - Properties
    static let id = "MP_ContentCVCell"
...
extension MP_ContentCVCell {
    ...
    private func configreCell() {
        ...
        let gr = createGradient(
            ...
            firstColor: UIColor(hex: 0x757575),
            lastColor: UIColor(hex: 0x505050),
...
extension MP_ContentCVCell {
    ...
    func updateUI(photo: PhotoModel, indexPath: IndexPath) {
        ...
        coverImageView.layer.maskedCorners = maskedCorners
    }
}
