...
extension CollisionDetectable {
    ...
    func prepareAllCollisionDetectorsIfNeeded(
        with rotationDegree: CGFloat,
        speed: CGFloat,
        ...
        onCenterCollision: ((_ progress: Double?) -> Void)? = nil) 
    {
            prepareCollisionDetectorIfNeeded(
                for: .edge,
                with: rotationDegree,
                speed: speed,
    ...
    func prepareCollisionDetectorIfNeeded(
        for type: CollisionType,
        with rotationDegree: CGFloat,
        speed: CGFloat,
        speedAcceleration: CGFloat,
        onCollision: ((_ progress: Double?) -> Void)? = nil) 
    {
        ...
        case .edge:
            edgeCollisionDetector.onCollision = onCollision
            edgeCollisionDetector.prepareWithContinuousAnimation(
                sliceDegree: sliceDegree,
                rotationDegreeOffset: rotationOffset,
        ...
        case .center:
            centerCollisionDetector.onCollision = onCollision
            centerCollisionDetector.prepareWithContinuousAnimation(
                sliceDegree: sliceDegree,
                rotationDegreeOffset: rotationOffset,
                fullRotationDegree: rotationDegree,
                speed: speed,
